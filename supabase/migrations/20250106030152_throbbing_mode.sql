...
DROP POLICY IF EXISTS "Users can manage questions in their own problem sets" ON public.problem_set_questions;
DROP POLICY IF EXISTS "Users can view questions in public problem sets" ON public.problem_set_questions;

-- Create problem_sets table if it doesn't exist
...
-- Create problem_set_questions table if it doesn't exist
